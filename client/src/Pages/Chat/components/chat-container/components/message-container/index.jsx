...
import { GET_ALL_MESSAGES_ROUTE, HOST, GET_CHANNEL_MESSAGES_ROUTE } from "@/utils/constant";
...
const MessageConatiner = () => {
  ...
  // dowmloading file which is shared by the user
          ...
          {checkIfImage(message.fileUrl)
            ...
            : (
              <div className="flex flex-wrap items-center gap-4">
                <span className="text-white/80 text-2xl sm:text-3xl bg-black/20 rounded-full p-3">
                  <MdFolderZip />
                </span>
                <span className="text-sm sm:text-base text-white/90 break-all flex-1 min-w-0">
            ...
            ? (
              <div className="flex justify-start gap-3 items-center " >
                <Avatar className="h-8 w-8 rounded-full overflow-hidden">
                  ...
                  <AvatarFallback
                    className={`uppercase h-8 w-8 text-2xl flex justify-center items-center rounded-full ${getColor(message.sender.color)}`} >
                    {
